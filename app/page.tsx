  ...
  const features = [
    {
      ...
      description:
        'We prioritize issues that actually hurt your rankings. Fix what matters most.',
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-32 pb-24 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-xs font-medium mb-8 mt-[70px]">
            <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
            Chrome Extension
          </div>

          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">
            Supercharge Your Store SEO
          </h1>
          ...
          <div className="flex items-center justify-center gap-3">
            <Link href="/login">
              <Button
                size="lg"
                className="bg-black hover:bg-slate-800 h-11 px-6"
              >
                Start free
              </Button>
            </Link>
      ...
      <section id="pricing" className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((plan, index) => (
            ...
            >
              <Card
                className={`p-8 h-full transition-all duration-200 hover:shadow-lg ${
                  plan.popular ? 'border-2 border-black' : 'border'
                }`}
              >
                {plan.popular && (
                  <Badge className="mb-4 bg-black text-white text-xs">
                    Popular
                  </Badge>
                )}
